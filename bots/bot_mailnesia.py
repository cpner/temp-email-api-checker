...
def cmd_start(m):
    ...
    kb.add(types.InlineKeyboardButton("📧 Новая", callback_data="mn_new"))
    kb.add(types.InlineKeyboardButton("📥 Письма", callback_data="mn_inbox"))
    kb.add(types.InlineKeyboardButton("🔑 Ключ", callback_data="mn_key"))
    kb.add(types.InlineKeyboardButton("📋 Данные", callback_data="mn_info"))
    kb.add(types.InlineKeyboardButton("❓ Помощь", callback_data="mn_help"))
    text = (
        "📧 *Mailnesia Bot*\n"
        "Анонимная\n\n"
        "/new — Создать почту\n"
