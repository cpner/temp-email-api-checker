...
def cmd_start(m):
    ...
    kb.add(types.InlineKeyboardButton("📧 Новая", callback_data="bk_new"))
    kb.add(types.InlineKeyboardButton("📥 Письма", callback_data="bk_inbox"))
    kb.add(types.InlineKeyboardButton("🔑 Ключ", callback_data="bk_key"))
    kb.add(types.InlineKeyboardButton("📋 Данные", callback_data="bk_info"))
    kb.add(types.InlineKeyboardButton("❓ Помощь", callback_data="bk_help"))
    text = (
        "📧 *Burner.kiwi Bot*\n"
        "Быстрая\n\n"
        "/new — Создать почту\n"
