...
def cmd_start(m):
    ...
    kb.add(types.InlineKeyboardButton("📧 Новая", callback_data="ml_new"))
    kb.add(types.InlineKeyboardButton("📥 Письма", callback_data="ml_inbox"))
    kb.add(types.InlineKeyboardButton("🔑 Ключ", callback_data="ml_key"))
    kb.add(types.InlineKeyboardButton("📋 Данные", callback_data="ml_info"))
    kb.add(types.InlineKeyboardButton("❓ Помощь", callback_data="ml_help"))
    text = (
        "📧 *MailSlurp Bot*\n"
        "Тестовый API\n\n"
        "/new — Создать почту\n"
