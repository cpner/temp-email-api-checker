#!/usr/bin/env python3
"""
AnonymBox — Check Inbox

Provider: AnonymBox | Endpoint: api/v1/inbox/{email}
Docs: anonymbox.com
"""
...
def cmd_start(m):
    ...
    kb.add(types.InlineKeyboardButton("New Email", callback_data="ab_new"))
    kb.add(types.InlineKeyboardButton("Inbox", callback_data="ab_inbox"))
    kb.add(types.InlineKeyboardButton("Info", callback_data="ab_info"))
    kb.add(types.InlineKeyboardButton("Help", callback_data="ab_help"))
    bot.send_message(m.chat.id, "*AnonymBox*\n\n\n/new — Create\n/inbox — Check\n/info — Info\n/help — Help", parse_mode="Markdown", reply_markup=kb)
