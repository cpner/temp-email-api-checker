#!/usr/bin/env python3
"""
EmailOnDeck — Telegram-бот временной почты
...
Исходный код: https://github.com/cpner/temp-email-api-checker/blob/main/russian/telebot/bot_emailondeck.py
Лицензия: MIT
"""
...
# Текстовые сообщения
SOURCE_URL = "https://github.com/cpner/temp-email-api-checker/blob/main/russian/telebot/bot_emailondeck.py"

START_TEXT = """*EmailOnDeck Бот*
Быстрая почта
