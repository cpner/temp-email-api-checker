...
Source: https://github.com/cpner/temp-email-api-checker/blob/main/russian/telebot/bot_tempmail_plus.py
License: MIT
"""
import telebot
...
Код: https://github.com/cpner/temp-email-api-checker/blob/main/russian/telebot/bot_tempmail_plus.py
...
Лицензия: MIT", c, call.message.message_id, reply_markup=make_kb())
            ...
            bot.edit_message_text("Source: " + "https://github.com/cpner/temp-email-api-checker/blob/main/russian/telebot/bot_tempmail_plus.py", c, call.message.message_id, reply_markup=make_kb())
        elif call.data == "help":
