...
def make_kb():
    ...
    kb.add(types.InlineKeyboardButton("Инфо", callback_data="info"), types.InlineKeyboardButton("Код", callback_data="source"))
...
def cb(call):
    ...
    try:
        if call.data == "new":
            ...
            bot.edit_message_text("Код: https://github.com/cpner/temp-email-api-checker/blob/main/english/telebot/bot_tempmail_plus.py", c, call.message.message_id, reply_markup=make_kb())
        elif call.data == "help":
