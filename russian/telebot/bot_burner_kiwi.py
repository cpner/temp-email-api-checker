#!/usr/bin/env python3
"""
Burner.kiwi — Telegram-бот временной почты
...
Исходный код: https://github.com/cpner/temp-email-api-checker/blob/main/russian/telebot/bot_burner_kiwi.py
Лицензия: MIT
"""
...
# Текстовые сообщения
SOURCE_URL = "https://github.com/cpner/temp-email-api-checker/blob/main/russian/telebot/bot_burner_kiwi.py"

START_TEXT = """*Burner.kiwi Бот*
Быстрая 24ч почта

*Возможности:*
Быстрое создание, 24ч
...
INFO_TEXT = """*Burner.kiwi — Инфо*

*Сервис:* Burner.kiwi
*Описание:* Быстрая 24ч почта
*Возможности:* Быстрое создание, 24ч
*API:* `https://burner.kiwi`
