#!/usr/bin/env python3
"""
10MinuteMail — Telegram-бот временной почты
...
Исходный код: https://github.com/cpner/temp-email-api-checker/blob/main/russian/telebot/bot_10minutemail.py
Лицензия: MIT
"""
...
# Текстовые сообщения
SOURCE_URL = "https://github.com/cpner/temp-email-api-checker/blob/main/russian/telebot/bot_10minutemail.py"

START_TEXT = """*10MinuteMail Бот*
Почта истекает через 10 минут
...
INFO_TEXT = """*10MinuteMail — Инфо*

*Сервис:* 10MinuteMail
*Описание:* Почта истекает через 10 минут
*Возможности:* Автоудаление, таймер
*API:* `https://10minutemail.net/address.api.php`
...
HELP_TEXT = """*10MinuteMail — Команды*
