#!/usr/bin/env python3
"""
Mail.tm — Telegram-бот временной почты
...
Исходный код: https://github.com/cpner/temp-email-api-checker/blob/main/russian/telebot/bot_mail_tm.py
Лицензия: MIT
"""
...
# Текстовые сообщения
SOURCE_URL = "https://github.com/cpner/temp-email-api-checker/blob/main/russian/telebot/bot_mail_tm.py"

START_TEXT = """*Mail.tm Бот*
REST API с созданием аккаунтов

*Возможности:*
Домены, аккаунты, входящие, чтение
...
INFO_TEXT = """*Mail.tm — Инфо*

*Сервис:* Mail.tm
*Описание:* REST API с созданием аккаунтов
*Возможности:* Домены, аккаунты, входящие, чтение
*API:* `https://api.mail.tm`
*Сайт:* https://mail.tm
*Код:* """ + SOURCE_URL + """
*Автор:* Владислав Софронов (cpner)
