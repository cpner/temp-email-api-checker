#!/usr/bin/env python3
"""
YOPmail — Telegram-бот временной почты
...
Исходный код: https://github.com/cpner/temp-email-api-checker/blob/main/russian/telebot/bot_yopmail.py
Лицензия: MIT
"""
...
# Текстовые сообщения
SOURCE_URL = "https://github.com/cpner/temp-email-api-checker/blob/main/russian/telebot/bot_yopmail.py"

START_TEXT = """*YOPmail Бот*
Многодоменная почта

*Возможности:*
Проверка, список доменов
...
INFO_TEXT = """*YOPmail — Инфо*

*Сервис:* YOPmail
*Описание:* Многодоменная почта
*Возможности:* Проверка, список доменов
*API:* `https://yopmail.com`
