...
Исходный код: https://github.com/cpner/temp-email-api-checker/blob/main/russian/telebot/bot_mailnesia.py
Лицензия: MIT
"""
...
# Текстовые сообщения
SOURCE_URL = "https://github.com/cpner/temp-email-api-checker/blob/main/russian/telebot/bot_mailnesia.py"

START_TEXT = """*Mailnesia Бот*
Анонимная почта

*Возможности:*
Проверка, прямые ссылки
...
INFO_TEXT = """*Mailnesia — Инфо*

*Сервис:* Mailnesia
*Описание:* Анонимная почта
*Возможности:* Проверка, прямые ссылки
*API:* `https://mailnesia.com`
