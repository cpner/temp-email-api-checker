#!/usr/bin/env python3
"""
AnonymBox — Telegram-бот временной почты
...
Исходный код: https://github.com/cpner/temp-email-api-checker/blob/main/russian/telebot/bot_anonymbox.py
Лицензия: MIT
"""
...
# Текстовые сообщения
SOURCE_URL = "https://github.com/cpner/temp-email-api-checker/blob/main/russian/telebot/bot_anonymbox.py"

START_TEXT = """*AnonymBox Бот*
...
INFO_TEXT = """*AnonymBox — Инфо*

*Сервис:* AnonymBox
*Описание:* Анонимный мониторинг
*Возможности:* Установка, проверка
*API:* `https://api.anonymbox.com/v1`
*Сайт:* https://anonymbox.com
*Код:* """ + SOURCE_URL + """
*Автор:* Владислав Софронов (cpner)
*Лицензия:* MIT"""

HELP_TEXT = """*AnonymBox — Команды*
