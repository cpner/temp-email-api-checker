...
Код: https://github.com/cpner/temp-email-api-checker/blob/main/russian/aiogram-2/bot_anonymbox.py
Лицензия: MIT
"""
...
# Text messages
SOURCE_URL = "https://github.com/cpner/temp-email-api-checker/blob/main/russian/aiogram-2/bot_anonymbox.py"
...
*Service:* AnonymBox
*Description:* Анонимный мониторинг
*API:* `https://api.anonymbox.com/v1`
