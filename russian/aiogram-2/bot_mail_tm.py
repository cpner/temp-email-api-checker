...
Код: https://github.com/cpner/temp-email-api-checker/blob/main/russian/aiogram-2/bot_mail_tm.py
Лицензия: MIT
"""
...
# Text messages
SOURCE_URL = "https://github.com/cpner/temp-email-api-checker/blob/main/russian/aiogram-2/bot_mail_tm.py"

START_TEXT = """*Mail.tm Bot*
REST API с аккаунтами

*Возможности:*
Домены, аккаунты, входящие
...
*Service:* Mail.tm
*Description:* REST API с аккаунтами
*API:* `https://api.mail.tm`
