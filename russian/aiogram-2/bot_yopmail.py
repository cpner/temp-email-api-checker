...
Код: https://github.com/cpner/temp-email-api-checker/blob/main/russian/aiogram-2/bot_yopmail.py
Лицензия: MIT
"""
...
# Text messages
SOURCE_URL = "https://github.com/cpner/temp-email-api-checker/blob/main/russian/aiogram-2/bot_yopmail.py"
...
*Service:* YOPmail
*Description:* Многодоменная почта
*API:* `https://yopmail.com`
