...
Код: https://github.com/cpner/temp-email-api-checker/blob/main/russian/aiogram-2/bot_mailnesia.py
Лицензия: MIT
"""
...
# Text messages
SOURCE_URL = "https://github.com/cpner/temp-email-api-checker/blob/main/russian/aiogram-2/bot_mailnesia.py"
