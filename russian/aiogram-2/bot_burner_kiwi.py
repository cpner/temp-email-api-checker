...
Код: https://github.com/cpner/temp-email-api-checker/blob/main/russian/aiogram-2/bot_burner_kiwi.py
Лицензия: MIT
"""
...
# Text messages
SOURCE_URL = "https://github.com/cpner/temp-email-api-checker/blob/main/russian/aiogram-2/bot_burner_kiwi.py"
...
def handle_new(uid, s):
    """Create new email."""
    return "Visit https://burner.kiwi"
