...
Код: https://github.com/cpner/temp-email-api-checker/blob/main/russian/aiogram-2/bot_tempmail_lol.py
Лицензия: MIT
"""
...
# Text messages
SOURCE_URL = "https://github.com/cpner/temp-email-api-checker/blob/main/russian/aiogram-2/bot_tempmail_lol.py"
...
*Description:* Генерация почты + токен
*API:* `https://api.tempmail.lol`
...
def handle_inbox(uid, s):
    """Check inbox."""
    if not s.token: return "Сначала /new"
