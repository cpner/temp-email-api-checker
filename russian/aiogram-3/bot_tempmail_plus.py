...
Source: https://github.com/cpner/temp-email-api-checker/blob/main/russian/aiogram-3/bot_tempmail_plus.py
License: MIT
"""
...
Код: https://github.com/cpner/temp-email-api-checker/blob/main/russian/aiogram-3/bot_tempmail_plus.py
...
async def cb_source(call):
    await bot.edit_message_text("Source: " + "https://github.com/cpner/temp-email-api-checker/blob/main/russian/aiogram-3/bot_tempmail_plus.py", call.message.chat.id, call.message.message_id, reply_markup=make_kb())
