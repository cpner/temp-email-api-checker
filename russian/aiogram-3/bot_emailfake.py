...
Код: https://github.com/cpner/temp-email-api-checker/blob/main/russian/aiogram-2/bot_emailfake.py
Лицензия: MIT
"""
...
# Text messages
SOURCE_URL = "https://github.com/cpner/temp-email-api-checker/blob/main/russian/aiogram-2/bot_emailfake.py"
...
*Service:* EmailFake
*Description:* Простой мониторинг
*API:* `https://emailfake.com/api/v1`
