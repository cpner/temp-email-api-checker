...
Код: https://github.com/cpner/temp-email-api-checker/blob/main/russian/aiogram-2/bot_guerrilla.py
Лицензия: MIT
"""
...
# Text messages
SOURCE_URL = "https://github.com/cpner/temp-email-api-checker/blob/main/russian/aiogram-2/bot_guerrilla.py"

START_TEXT = """*Guerrilla Mail Bot*
Полный REST API для одноразовой почты

*Возможности:*
Создание, входящие, 9 языков
...
*Description:* Полный REST API для одноразовой почты
*API:* `https://api.guerrillamail.com/ajax.php`
