...
Код: https://github.com/cpner/temp-email-api-checker/blob/main/russian/aiogram-2/bot_emailnator.py
Лицензия: MIT
"""
...
# Text messages
SOURCE_URL = "https://github.com/cpner/temp-email-api-checker/blob/main/russian/aiogram-2/bot_emailnator.py"
...
INFO_TEXT = """*EmailNator — Инфо*

*Service:* EmailNator
*Description:* Генератор почты
*API:* `https://www.emailnator.com`
