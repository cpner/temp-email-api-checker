#!/usr/bin/env python3
"""
AnonymBox — Telegram-бот временной почты (aiogram 3.x)
...
def handle_new(c, s, call):
    bot.send_message(cid,"Посетите https://api.anonymbox.com/v1")
...
async def cmd_info(m):
    await bot.send_message(m.chat.id,f"*AnonymBox*\n\n🌐 https://api.anonymbox.com/v1\n\nПосетите сайт.")
