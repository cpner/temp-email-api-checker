...
Код: https://github.com/cpner/temp-email-api-checker/blob/main/russian/aiogram-2/bot_emailondeck.py
Лицензия: MIT
"""
...
# Text messages
SOURCE_URL = "https://github.com/cpner/temp-email-api-checker/blob/main/russian/aiogram-2/bot_emailondeck.py"
...
INFO_TEXT = """*EmailOnDeck — Инфо*

*Service:* EmailOnDeck
*Description:* Быстрая почта
*API:* `https://api.emailondeck.com/v1`
