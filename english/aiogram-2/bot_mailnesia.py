#!/usr/bin/env python3
"""
Mailnesia — Telegram Bot for Temporary Email (aiogram 2.x)
Provider: Mailnesia
...
def cmd_check(m):
    ...
    await bot.send_message(m.chat.id, f"📬 Inbox: https://mailnesia.com/mailbox/{p[1].strip()}")
...
async def cb(call: types.CallbackQuery):
    ...
    if a == "new":
        ...
        bot.send_message(c, "📬 mailnesia.com")
    elif a == "info":
        s = gs(c)
