...
Source: https://github.com/cpner/temp-email-api-checker/blob/main/english/aiogram-2/bot_yopmail.py/blob/main/english/aiogram-2/bot_yopmail.py
License: MIT
"""
...
# Text messages
SOURCE_URL = "https://github.com/cpner/temp-email-api-checker/blob/main/english/aiogram-2/bot_yopmail.py"
...
def handle_new(uid, s):
    """Create new email."""
    return "Visit https://yopmail.com"
