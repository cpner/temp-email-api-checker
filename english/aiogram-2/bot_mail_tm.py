...
Source: https://github.com/cpner/temp-email-api-checker/blob/main/english/aiogram-2/bot_mail_tm.py/blob/main/english/aiogram-2/bot_mail_tm.py
License: MIT
"""
...
# Text messages
SOURCE_URL = "https://github.com/cpner/temp-email-api-checker/blob/main/english/aiogram-2/bot_mail_tm.py"

START_TEXT = """*Mail.tm Bot*
REST API with account creation

*Features:*
Domains, accounts, inbox
