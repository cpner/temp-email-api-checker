...
Source: https://github.com/cpner/temp-email-api-checker/blob/main/english/telebot/bot_emailnator.py
License: MIT
"""
...
# ═══════════════════════════════════════════════════════════════
SOURCE_URL = "https://github.com/cpner/temp-email-api-checker/blob/main/english/telebot/bot_emailnator.py"

START_TEXT = """*EmailNator Bot*
...
INFO_TEXT = """*EmailNator — Info*

*Service:* EmailNator
*Description:* Disposable email generator
*Features:* Generate, check
*API:* `https://www.emailnator.com`
...
def api_get(path: str = "", params: Optional[Dict] = None, headers: Optional[Dict] = None) -> Dict[str, Any]:
    """Make GET request to EmailNator API with retry logic.
...
def api_post(path: str = "", data: Optional[Dict] = None, headers: Optional[Dict] = None) -> Dict[str, Any]:
    """Make POST request to EmailNator API.
...
def handle_new(user_id: int, session: UserSession) -> str:
    """Create a new EmailNator email address.
