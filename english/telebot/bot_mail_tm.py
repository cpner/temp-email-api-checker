...
Source: https://github.com/cpner/temp-email-api-checker/blob/main/english/telebot/bot_mail_tm.py
License: MIT
"""
...
# ═══════════════════════════════════════════════════════════════
SOURCE_URL = "https://github.com/cpner/temp-email-api-checker/blob/main/english/telebot/bot_mail_tm.py"

START_TEXT = """*Mail.tm Bot*
REST API with account creation

*Features:*
Domains, accounts, inbox, read
...
INFO_TEXT = """*Mail.tm — Info*

*Service:* Mail.tm
*Description:* REST API with account creation
*Features:* Domains, accounts, inbox, read
*API:* `https://api.mail.tm`
...
def api_get(path: str = "", params: Optional[Dict] = None, headers: Optional[Dict] = None) -> Dict[str, Any]:
    """Make GET request to Mail.tm API with retry logic.
...
def api_post(path: str = "", data: Optional[Dict] = None, headers: Optional[Dict] = None) -> Dict[str, Any]:
    """Make POST request to Mail.tm API.
...
def handle_new(user_id: int, session: UserSession) -> str:
    """Create a new Mail.tm email address.
