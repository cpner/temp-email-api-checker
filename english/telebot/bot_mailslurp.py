...
Source: https://github.com/cpner/temp-email-api-checker/blob/main/english/telebot/bot_mailslurp.py
License: MIT
"""
...
# ═══════════════════════════════════════════════════════════════
SOURCE_URL = "https://github.com/cpner/temp-email-api-checker/blob/main/english/telebot/bot_mailslurp.py"

START_TEXT = """*MailSlurp Bot*
Professional testing API

*Features:*
Inboxes, domains, create (key)
...
*Features:* Inboxes, domains, create (key)
*API:* `https://api.mailslurp.com`
...
def api_get(path: str = "", params: Optional[Dict] = None, headers: Optional[Dict] = None) -> Dict[str, Any]:
    """Make GET request to MailSlurp API with retry logic.
...
def api_post(path: str = "", data: Optional[Dict] = None, headers: Optional[Dict] = None) -> Dict[str, Any]:
    """Make POST request to MailSlurp API.
...
def handle_new(user_id: int, session: UserSession) -> str:
    """Create a new MailSlurp email address.
