...
Source: https://github.com/cpner/temp-email-api-checker/blob/main/english/telebot/bot_mailsac.py
License: MIT
"""
...
# ═══════════════════════════════════════════════════════════════
SOURCE_URL = "https://github.com/cpner/temp-email-api-checker/blob/main/english/telebot/bot_mailsac.py"

START_TEXT = """*MailSac Bot*
Professional API with key

*Features:*
Domains, messages (API key)
...
INFO_TEXT = """*MailSac — Info*

*Service:* MailSac
*Description:* Professional API with key
*Features:* Domains, messages (API key)
*API:* `https://mailsac.com/api`
...
def api_get(path: str = "", params: Optional[Dict] = None, headers: Optional[Dict] = None) -> Dict[str, Any]:
    """Make GET request to MailSac API with retry logic.
...
def api_post(path: str = "", data: Optional[Dict] = None, headers: Optional[Dict] = None) -> Dict[str, Any]:
    """Make POST request to MailSac API.
...
def handle_new(user_id: int, session: UserSession) -> str:
    """Create a new MailSac email address.
