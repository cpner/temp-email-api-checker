...
Source: https://github.com/cpner/temp-email-api-checker/blob/main/english/telebot/bot_tempmail_lol.py
License: MIT
"""
...
# ═══════════════════════════════════════════════════════════════
SOURCE_URL = "https://github.com/cpner/temp-email-api-checker/blob/main/english/telebot/bot_tempmail_lol.py"

START_TEXT = """*TempMail.lol Bot*
Generate email + auth token

*Features:*
Generate, auth token, check inbox
...
*Features:* Generate, auth token, check inbox
*API:* `https://api.tempmail.lol`
...
def api_get(path: str = "", params: Optional[Dict] = None, headers: Optional[Dict] = None) -> Dict[str, Any]:
    """Make GET request to TempMail.lol API with retry logic.
...
def api_post(path: str = "", data: Optional[Dict] = None, headers: Optional[Dict] = None) -> Dict[str, Any]:
    """Make POST request to TempMail.lol API.
...
def handle_new(user_id: int, session: UserSession) -> str:
    """Create a new TempMail.lol email address.
