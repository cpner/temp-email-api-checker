...
Source: https://github.com/cpner/temp-email-api-checker/blob/main/english/telebot/bot_yopmail.py
License: MIT
"""
...
# ═══════════════════════════════════════════════════════════════
SOURCE_URL = "https://github.com/cpner/temp-email-api-checker/blob/main/english/telebot/bot_yopmail.py"

START_TEXT = """*YOPmail Bot*
...
def api_get(path: str = "", params: Optional[Dict] = None, headers: Optional[Dict] = None) -> Dict[str, Any]:
    """Make GET request to YOPmail API with retry logic.
...
def api_post(path: str = "", data: Optional[Dict] = None, headers: Optional[Dict] = None) -> Dict[str, Any]:
    """Make POST request to YOPmail API.
...
def handle_new(user_id: int, session: UserSession) -> str:
    """Create a new YOPmail email address.
