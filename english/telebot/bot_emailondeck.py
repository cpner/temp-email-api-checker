...
Source: https://github.com/cpner/temp-email-api-checker/blob/main/english/telebot/bot_emailondeck.py
License: MIT
"""
...
logger = logging.getLogger("EmailOnDeck")

# ═══════════════════════════════════════════════════════════════
# Bot Configuration
# ═══════════════════════════════════════════════════════════════
BOT_TOKEN = os.environ.get("BOT_TOKEN_EMAILONDECK", "YOUR_BOT_TOKEN")
...
# ═══════════════════════════════════════════════════════════════
SOURCE_URL = "https://github.com/cpner/temp-email-api-checker/blob/main/english/telebot/bot_emailondeck.py"

START_TEXT = """*EmailOnDeck Bot*
...
INFO_TEXT = """*EmailOnDeck — Info*

*Service:* EmailOnDeck
*Description:* Fast disposable email
*Features:* Quick create
*API:* `https://api.emailondeck.com/v1`
*Website:* https://emailondeck.com
*Source:* """ + SOURCE_URL + """
*Author:* Vladislav Sofronov (@icesq)
*License:* MIT"""

HELP_TEXT = """*EmailOnDeck — Commands*
...
def api_get(path: str = "", params: Optional[Dict] = None, headers: Optional[Dict] = None) -> Dict[str, Any]:
    """Make GET request to EmailOnDeck API with retry logic.
...
def api_post(path: str = "", data: Optional[Dict] = None, headers: Optional[Dict] = None) -> Dict[str, Any]:
    """Make POST request to EmailOnDeck API.
...
def handle_new(user_id: int, session: UserSession) -> str:
    """Create a new EmailOnDeck email address.
