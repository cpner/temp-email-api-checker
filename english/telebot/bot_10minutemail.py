...
def cmd_info(m):
    bot.send_message(m.chat.id, '*10MinuteMail Bot — Info*\\n\\n*Service:* 10MinuteMail\\n*Description:* Email that expires in 10 minutes\\n*Features:* Auto-expiring, timer display\\n*API:* `https://10minutemail.net/address.api.php`\\n*Website:* https://10minutemail.net\\n*Source:* https://github.com/cpner/temp-email-api-checker/blob/main/en/telebot/bot_10minutemail.py\\n*Author:* Vladislav Sofronov (cpner)\\n*License:* MIT', reply_markup=make_kb())

@bot.message_handler(commands=["help"])
def cmd_help(m):
    bot.send_message(m.chat.id, '*10MinuteMail Bot — Commands*\\n\\n/start — Main menu\\n/new — Create email\\n/inbox — Check messages\\n/set — Set email manually\\n/info — Bot information\\n/help — This help\\n\\n*Buttons:*\\n📧 New Email — Create address\\n📥 Inbox — Check messages\\nℹ️ Info — Bot details\\n🔗 Source — GitHub link\\n❓ Help — Usage guide', reply_markup=make_kb())
...
def cb(call):
    ...
    try:
        ...
        if a == "new":
            ...
            bot.send_message(c, '*10MinuteMail Bot — Commands*\\n\\n/start — Main menu\\n/new — Create email\\n/inbox — Check messages\\n/set — Set email manually\\n/info — Bot information\\n/help — This help\\n\\n*Buttons:*\\n📧 New Email — Create address\\n📥 Inbox — Check messages\\nℹ️ Info — Bot details\\n🔗 Source — GitHub link\\n❓ Help — Usage guide', reply_markup=make_kb())
    except Exception as e:
