...
Source: https://github.com/cpner/temp-email-api-checker/blob/main/english/aiogram-3/bot_emailnator.py/blob/main/english/aiogram-2/bot_emailnator.py
License: MIT
"""
...
# Text messages
SOURCE_URL = "https://github.com/cpner/temp-email-api-checker/blob/main/english/aiogram-2/bot_emailnator.py"
...
def handle_new(uid, s):
    """Create new email."""
    return "Visit https://www.emailnator.com"
