#!/usr/bin/env python3
"""
EmailOnDeck Telegram Bot (aiogram 3.x)
...
Source: https://github.com/cpner/temp-email-api-checker/blob/main/english/aiogram-3/bot_emailondeck.py/blob/main/english/aiogram-2/bot_emailondeck.py
License: MIT
"""
