#!/usr/bin/env python3
"""
MailSac Telegram Bot (aiogram 3.x)
...
async def cmd_info(m):
    await m.answer('*MailSac Bot — Info*\\n\\n*Service:* MailSac\\n*Description:* Professional API with key support\\n*Features:* Domains, messages (API key required)\\n*API:* `https://mailsac.com/api`\\n*Website:* https://mailsac.com\\n*Source:* https://github.com/cpner/temp-email-api-checker/blob/main/en/aiogram-3/bot_mailsac.py\\n*Author:* Vladislav Sofronov (cpner)\\n*License:* MIT', reply_markup=make_kb())

@dp.message(F.text == "/help")
async def cmd_help(m):
    await m.answer('*MailSac Bot — Commands*\\n\\n/start — Main menu\\n/new — Create email\\n/inbox — Check messages\\n/set — Set email manually\\n/info — Bot information\\n/help — This help\\n\\n*Buttons:*\\n📧 New Email — Create address\\n📥 Inbox — Check messages\\nℹ️ Info — Bot details\\n🔗 Source — GitHub link\\n❓ Help — Usage guide', reply_markup=make_kb())
...
async def cb_help(call):
    await bot.send_message(call.message.chat.id, '*MailSac Bot — Commands*\\n\\n/start — Main menu\\n/new — Create email\\n/inbox — Check messages\\n/set — Set email manually\\n/info — Bot information\\n/help — This help\\n\\n*Buttons:*\\n📧 New Email — Create address\\n📥 Inbox — Check messages\\nℹ️ Info — Bot details\\n🔗 Source — GitHub link\\n❓ Help — Usage guide', reply_markup=make_kb())
