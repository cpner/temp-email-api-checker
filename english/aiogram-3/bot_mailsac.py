...
Source: https://github.com/cpner/temp-email-api-checker/blob/main/english/aiogram-3/bot_mailsac.py/blob/main/english/aiogram-2/bot_mailsac.py
License: MIT
"""
...
# Text messages
SOURCE_URL = "https://github.com/cpner/temp-email-api-checker/blob/main/english/aiogram-2/bot_mailsac.py"

START_TEXT = """*MailSac Bot*
Professional API with key

*Features:*
Domains, messages (key)
