...
Source: https://github.com/cpner/temp-email-api-checker/blob/main/english/aiogram-3/bot_tempmail_lol.py/blob/main/english/aiogram-2/bot_tempmail_lol.py
License: MIT
"""
...
# Text messages
SOURCE_URL = "https://github.com/cpner/temp-email-api-checker/blob/main/english/aiogram-2/bot_tempmail_lol.py"

START_TEXT = """*TempMail.lol Bot*
Generate email + auth token

*Features:*
Generate, auth token, check
...
INFO_TEXT = """*TempMail.lol — Info*

*Service:* TempMail.lol
*Description:* Generate email + auth token
*API:* `https://api.tempmail.lol`
*Website:* https://tempmail.lol
*Source:* """ + SOURCE_URL + """
*Author:* Vladislav Sofronov (@icesq)
*License:* MIT"""

HELP_TEXT = """*TempMail.lol — Commands*
...
def handle_inbox(uid, s):
    ...
    if not emails: return "Empty inbox"
    t = str(len(emails)) + " messages:\n"
    for e in emails[:15]: s.seen.add(e.get("id")); t += e.get("id","?")+" | "+e.get("from","?")+" | "+e.get("subject","-")+"\n"
    return t
